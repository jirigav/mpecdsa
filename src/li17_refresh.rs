...
pub type Li17RefreshP1Msg2 = (coin_flip_optimal_rounds::Party1SecondMessage::<Secp256r1, Sha256>,
...
pub fn li17_p1_refresh1( context: Li17SignP1Context ) -> Result<(Li17RefreshP1Msg1, Li17RefreshP1Context1), &'static str> {
...
pub fn li17_p1_refresh2( msg: Li17RefreshP2Msg1,context: Li17RefreshP1Context1 )
-> Result<(Li17RefreshP1Msg2, Li17SignP1Context), &'static str> {
    ...
    let (p1_second_message, res) = coin_flip_optimal_rounds::Party1SecondMessage::<Secp256r1, Sha256>::reveal(
                        &msg.seed, &context.p1_m1, &context.p1_r1);
    ...
    Ok(((p1_second_message, correct_key_proof, pdl_statement,
                     pdl_proof, composite_dlog_proof, ek_new, c_key_new), sign_context))
}

pub fn li17_p2_refresh1( msg: Li17RefreshP1Msg1,context: Li17SignP2Context)
...
pub fn li17_p2_refresh2( msg: Li17RefreshP1Msg2,context: Li17RefreshP2Context1 )
