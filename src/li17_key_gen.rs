...
pub type Li17KeyGenP1Msg2 = (party_one::KeyGenSecondMsg, NiCorrectKeyProof, PDLwSlackStatement,
...
pub fn li17_p1_key_gen2( msg: Li17KeyGenP2Msg1, context: Li17KeyGenP1Context1 )
-> Result<(Li17KeyGenP1Msg2, Li17SignP1Context), &'static str> {

    let p1_second_message = party_one::KeyGenSecondMsg::verify_and_decommit(context.p1_comm_witness, &msg.d_log_proof);
    ...
    let paillier_key_pair = party_one::PaillierKeyPair::generate_keypair_and_encrypted_share(&context.p1_ec_key_pair);
    let party_one_private = party_one::Party1Private::set_private_key(&context.p1_ec_key_pair, &paillier_key_pair);
   ...
   let party_one_private = party_one::Party1Private::set_private_key(&context.p1_ec_key_pair,
                                                               &paillier_key_pair);
   ...
   Ok(((p1_second_message, correct_key_proof, pdl_statement, pdl_proof, composite_dlog_proof,
                  ek, encrypted_share), sign_context))
}

// party two functions
pub fn li17_p2_key_gen1( msg: Li17KeyGenP1Msg1 )
...
pub fn li17_p2_key_gen2( msg: Li17KeyGenP1Msg2, context: Li17KeyGenP2Context1 )
->  Result<(Li17KeyGenP2Msg2, Li17SignP2Context), &'static str> {
    ...
    let (party_one_second_message, correct_key_proof, pdl_statement, pdl_proof,
        composite_dlog_proof, paillier_ek, paillier_encrypted_share) = msg;
    ...
    let public_key = party_two::compute_pubkey(&context.p2_ec_key_pair, &party_one_second_message.comm_witness.public_share);
